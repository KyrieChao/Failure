...
class ExTest {
    ...
    class PrivateMethods {
        ...
        void testCaptureMethodNameSkipsValidatorsClass() throws Throwable {
            ...
            String methodName = com.chao.failure.exsupport.Caller.call(handle);
        ...
        void testIsNotSkippedForSkippedPackage() {
            ...
            com.chao.failure.config.registry.DefaultSkipPrefixRegistry registry = new com.chao.failure.config.registry.DefaultSkipPrefixRegistry();
