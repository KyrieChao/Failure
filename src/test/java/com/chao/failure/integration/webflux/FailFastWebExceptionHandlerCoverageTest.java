...
class FailFastWebExceptionHandlerCoverageTest {
    ...
    void setUp() {
        ...
        context = new FailureContext(properties, new com.chao.failure.config.mapping.CodeMappingConfig(properties), null);
        com.chao.failure.internal.core.Ex.setContext(context);
    ...
    void shouldFallbackToContextWhenResolveTraceIdSeesBlankHeaderName() {
        ...
        FailureContext localContext = new FailureContext(localProperties, new com.chao.failure.config.mapping.CodeMappingConfig(localProperties), null);
