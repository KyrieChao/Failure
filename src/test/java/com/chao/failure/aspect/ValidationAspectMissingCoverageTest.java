...
import com.chao.failure.config.registry.DefaultValidatorRegistry;
...
class ValidationAspectMissingCoverageTest {
    ...
    void newValidatorInstanceShouldRejectNonWhitelistedValidator() throws Exception {
        ValidationAspect aspect = new ValidationAspect();
        ValidatorWhitelistRegistry whitelist = mock(ValidatorWhitelistRegistry.class);
    ...
    void should_stopAfterInstantiationFailure_when_executeValidatorsRunsInFailFastMode() throws Exception {
        ValidationAspect aspect = new ValidationAspect();
        setField(aspect, "applicationContext", mock(ApplicationContext.class));
        com.chao.failure.spi.validation.ValidatorWhitelistRegistry whitelist = mock(com.chao.failure.spi.validation.ValidatorWhitelistRegistry.class);
