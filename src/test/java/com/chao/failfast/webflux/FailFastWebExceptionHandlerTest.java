package com.chao.failfast.webflux;
...
class FailFastWebExceptionHandlerTest {
    ...
    void testTraceIdFromExchangeAttributes() {
        ...
        FailureContext context = new FailureContext(props, new com.chao.failfast.config.mapping.CodeMappingConfig(props), null);
        ...
        handler.handle(exchange, ex)
                .contextWrite(ctx -> ctx.put(com.chao.failfast.integration.webflux.ReactiveTrace.SCENE_KEY, "SCENE_A"))
                .block();
