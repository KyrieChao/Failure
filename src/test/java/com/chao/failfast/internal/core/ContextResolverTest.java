...
class ContextResolverTest {
    ...
    void testTraceIdWithNullContexts() {
        String traceId = ContextResolver.traceId(null, null);
        assertNull(traceId);
    }
    ...
    void testTraceIdWithViewOnly() {
        ...
        String traceId = ContextResolver.traceId(null, view);
    ...
    void testTraceIdWithBlankTraceId() {
        ...
        String traceId = ContextResolver.traceId(ctx, view);
    ...
    void testTraceIdWithContextOnly() {
        FailureContext ctx = Mockito.mock(FailureContext.class);
        when(ctx.getTraceId()).thenReturn("context-trace-id");
        String traceId = ContextResolver.traceId(ctx, null);
        assertEquals("context-trace-id", traceId);
    }

    @Test
    void testSceneWithNullContexts() {
        String scene = ContextResolver.scene(null, null);
        assertNull(scene);
    }
    ...
    void testSceneWithViewOnly() {
        ...
        String scene = ContextResolver.scene(null, view);
    ...
    void testSceneWithBlankScene() {
        ...
        String scene = ContextResolver.scene(ctx, view);
    ...
    void testSceneWithContextOnly() {
        FailureContext ctx = Mockito.mock(FailureContext.class);
        when(ctx.getScene()).thenReturn("context-scene");
        String scene = ContextResolver.scene(ctx, null);
        assertEquals("context-scene", scene);
    }

    @Test
    void testShadowTraceWithNullContexts() {
        boolean shadowTrace = ContextResolver.shadowTrace(null, null);
    ...
    void testShadowTraceWithViewOnly() {
        ...
        boolean shadowTrace = ContextResolver.shadowTrace(null, view);
    ...
    void testShadowTraceWithNonBooleanShadowTrace() {
        ...
        boolean shadowTrace = ContextResolver.shadowTrace(ctx, view);
        assertTrue(shadowTrace);
    }
    ...
    void testShadowTraceWithContextOnly() {
        FailureContext ctx = Mockito.mock(FailureContext.class);
        when(ctx.isShadowTrace()).thenReturn(true);
        boolean shadowTrace = ContextResolver.shadowTrace(ctx, null);
        assertTrue(shadowTrace);
    }

    @Test
    void testMethodEnabledWithNullContexts() {
        boolean methodEnabled = ContextResolver.methodEnabled(null, null);
    ...
    void testMethodEnabledWithViewOnly() {
        ...
        boolean methodEnabled = ContextResolver.methodEnabled(null, view);
    ...
    void testMethodEnabledWithNonBooleanMethodEnabled() {
        ...
        boolean methodEnabled = ContextResolver.methodEnabled(ctx, view);
        assertTrue(methodEnabled);
    }
    ...
    void testMethodEnabledWithContextOnly() {
        FailureContext ctx = Mockito.mock(FailureContext.class);
        when(ctx.isMethodEnabled()).thenReturn(true);
        boolean methodEnabled = ContextResolver.methodEnabled(ctx, null);
        assertTrue(methodEnabled);
    }
